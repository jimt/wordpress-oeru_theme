<?PHP	
	...
	class oeru_shortcode{
		...
		function analytics( $atts ) {
			global $post;
			// type="piwik" or "google", host=, id=
			if ( !isset( $post->oeru_analytics ) ) {
				$post->oeru_analytics = '';
			}
...
<script type="text/javascript">
  ...
  (function() {
    ...
    _paq.push(['setSiteId', {$atts['id']}]);
    var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0];
    g.type='text/javascript'; g.async=true; g.defer=true; g.src=u+'piwik.js'; s.parentNode.insertBefore(g,s);
  })();
</script>
<noscript><p><img src="$url/piwik.php?idsite={$atts['id']}" style="border:0;" alt="" /></p></noscript>
EOT;
				break;
			case 'google':
				$post->oeru_analytics .= <<<EOT
...
EOT;
		...
		function analytics_show() {
			global $post;

			if ( isset( $post->oeru_analytics ) ) {
				echo $post->oeru_analytics;
			}
		}
		...
		function device( $atts, $content = null ){
			...
			$icon = array(
				...
				'Line-black' => array(
					...
					'aims' => 'black/Icon_objectives.png',
					'portfolio activity' => 'black/Icon_activity.png',
					'extension exercise' => 'black/Icon_activity.png',
					'assignment' => 'black/Icon_assess.png',
					'question' => 'black/Icon_qmark.png',
					'questions' => 'black/Icon_qmark.png',
					'did you know' => 'black/Icon_qmark.png',
					'did you know?' => 'black/Icon_qmark.png',
					'did you notice' => 'black/Icon_qmark.png',
					'did you notice?' => 'black/Icon_qmark.png',
					'definition' => 'black/Icon_define.png',
					'definitions' => 'black/Icon_define.png',
					'discussion' => 'black/Icon_discussion.png',
					'tell us a story' => 'black/Icon_discussion.png',
					'case study' => 'black/Icon_casestudy.png',
					'example' => 'black/Icon_casestudy.png',
					'objective' => 'black/Icon_objectives.png',
					'objectives' => 'black/Icon_objectives.png',
					'outcomes' => 'black/Icon_objectives.png',
					'key point' => 'black/Icon_key_points.png',
					'key points' => 'black/Icon_key_points.png',
					'media required' => 'black/Icon_multimedia.png',
					'media' => 'black/Icon_multimedia.png',
					'reading' => 'black/Icon_reading.png',
					'competency' => 'black/Icon_review.png',
					'competencies' => 'black/Icon_review.png',
					'summary' => 'black/Icon_summary.png',
					'self assessment' => 'black/Icon_qmark.png',
					'assessment' => 'black/Icon_qmark.png',
					'reflection' => 'black/Icon_reflection.png',
					'preknowledge' => 'black/Icon_preknowledge.png',
					'web resources' => 'black/Icon_inter.png',
					'default' => 'black/Icon_qmark.png'
				),
				'Ind' => array(
...
EOD;
	...
	add_shortcode( 'oeru_analytics', array( $shortcode, 'analytics' ) );
	add_action( 'oeru_post_footer', array( $shortcode, 'analytics_show' ) );
